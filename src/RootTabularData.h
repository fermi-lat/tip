/** \file RootTabularData.h

    \brief Root-specific implmentation of the ITabularData interface.

    \author James Peachey, HEASARC
*/
#ifndef table_RootTabularData_h
#define table_RootTabularData_h
...
namespace table {
  ...
  /** \class RootTabularData

      \brief Root-specific implmentation of the ITabularData interface.
  */
  class RootTabularData : public ITabularData {
    public:
      /** \brief Create a RootTabularData object which refers to the given utility object.
          \param root_utils Pointer to the Root utility object.
      */
      RootTabularData(RootExtensionUtils * root_utils);

      virtual ~RootTabularData() {}
