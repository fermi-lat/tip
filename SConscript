# -*- python -*-
# $Id: SConscript,v 1.6.42.1 2009/01/14 16:52:28 ecephas Exp $
...
if baseEnv['PLATFORM'] != 'win32':
    ...
    test_tip_main_obj = test2Env.StaticObject(target = 'test_tip_main_obj.o', 
					 source = ['src/test/test_tip_main.cxx'])
